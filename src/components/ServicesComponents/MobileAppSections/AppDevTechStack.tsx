        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {technologies.map((tech, index) => (
            <motion.div
              ...
              className="group relative p-8 rounded-2xl bg-blue-500/5 backdrop-blur-sm 
                border border-blue-500/10 hover:border-blue-400/30 
                shadow-lg hover:shadow-blue-500/10 transition-all duration-300"
            >
              <div className="relative z-10">
                <div className="mb-4 p-2 rounded-lg bg-gradient-to-r from-blue-400 to-blue-600 inline-block">
                  {tech.icon}
                </div>
                
                <h3 className="text-xl font-bold mb-2 text-blue-200/80 group-hover:text-blue-100 transition-colors duration-300">
                  {tech.category}
                </h3>
                  ...
                  {tech.tools.map((tool, toolIndex) => (
                    <span
                      ...
                      className="px-3 py-1 text-sm rounded-full 
                        bg-blue-500/10 text-blue-200/80 border border-blue-500/20
